...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'worker.data';
      var REMOTE_PACKAGE_BASE = 'worker.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_worker.data');

      };
      Module['addRunDependency']('datafile_worker.data');
   ...
   loadPackage({"files": [{"filename": "/file.dat", "start": 0, "end": 15, "audio": 0}], "remote_package_size": 15, "package_uuid": "60398438-e28a-4fd0-9781-214da1f7fe6a"});
