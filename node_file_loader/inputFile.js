...
var ASM_CONSTS = {
  16900: function($0) {FS.mkdir('/temp'); FS.mount(NODEFS, {root : '.'}, '/temp'); var fn = UTF8ToString($0); var test = FS.readFile('/temp/' + fn, {encoding: 'utf8'}); console.log("Text from test file: ", test);}
};
